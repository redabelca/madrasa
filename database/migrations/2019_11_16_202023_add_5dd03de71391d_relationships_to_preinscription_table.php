...
class Add5dd03de71391dRelationshipsToPreinscriptionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('preinscriptions', function(Blueprint $table) {
            if (!Schema::hasColumn('preinscriptions', 'anneescolaire_id')) {
                ...
                if (!Schema::hasColumn('preinscriptions', 'eleve_id')) {
                $table->integer('eleve_id')->unsigned()->nullable();
                $table->foreign('eleve_id', '42611_5dd03de62b20e')->references('id')->on('eleves')->onDelete('cascade');
                }
