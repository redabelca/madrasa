...
export default {
    ...
    methods: {
        ...mapActions('VehiculesSingle', ['fetchData', 'updateData', 'resetState', 'setCode', 'setMarque', 'setMatricule', 'setDatemiseencirculation', 'setDateacquisition', 'setEcheanceassurance', 'setNombredeplace', 'setEcheancevisitetechnique', 'setEcheanceautorisation', 'setConsommationmin', 'setConsommationmax', 'setVidange', 'setObservations']),
        updateCode(e) {
