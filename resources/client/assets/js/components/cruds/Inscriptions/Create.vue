...
export default {
    ...
    methods: {
        ...mapActions('InscriptionsSingle', ['storeData', 'resetState', 'setDateentree', 'setInterne', 'setClasse', 'setCircuit', 'setNiveau', 'setAnneescolaire', 'setPreinscription', 'fetchClassesAll', 'fetchCircuitsAll', 'fetchNiveauxAll', 'fetchAnneescolairesAll', 'fetchPreinscriptionsAll']),
        updateDateentree(e) {
