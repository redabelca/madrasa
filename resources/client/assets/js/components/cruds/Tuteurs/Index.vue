...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Ville', field: 'ville', sortable: true },
                { title: 'Profession', field: 'profession', sortable: true },
                { title: 'Lien Parente', field: 'lienparente', tdComp: DatatableSingle },
    ...
    computed: {
        ...mapGetters('TuteursIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('TuteursIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
