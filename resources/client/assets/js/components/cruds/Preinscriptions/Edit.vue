...
export default {
    ...
    methods: {
        ...mapActions('PreinscriptionsSingle', ['fetchData', 'updateData', 'resetState', 'setNomprofesseurtest', 'setNotetest', 'setResultattest', 'setIs_acceptedintest', 'setFraistest', 'setFraispayed', 'setTransport', 'setDatetest', 'setDatelimiteinscription', 'setObservations', 'setAnneescolaire', 'setEleve']),
