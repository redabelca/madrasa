...
export default {
    ...
    computed: {
        ...mapGetters('PreinscriptionsSingle', ['item', 'loading', 'anneescolairesAll', 'elevesAll'])
    },
    created() {
    ...
    methods: {
        ...mapActions('PreinscriptionsSingle', ['storeData', 'resetState', 'setNomprofesseurtest', 'setNotetest', 'setResultattest', 'setIs_acceptedintest', 'setFraistest', 'setFraispayed', 'setTransport', 'setDatetest', 'setDatelimiteinscription', 'setObservations', 'setAnneescolaire', 'setEleve', 'fetchAnneescolairesAll', 'fetchElevesAll']),
