...
const routes = [
    ...
    { path: '/inscriptions', component: InscriptionsIndex, name: 'inscriptions.index' },
    { path: '/inscriptions/create', component: InscriptionsCreate, name: 'inscriptions.create' },
    { path: '/inscriptions/:id', component: InscriptionsShow, name: 'inscriptions.show' },
    { path: '/inscriptions/:id/edit', component: InscriptionsEdit, name: 'inscriptions.edit' },
    ...
    { path: '/anneescolaires', component: AnneescolairesIndex, name: 'anneescolaires.index' },
    { path: '/anneescolaires/create', component: AnneescolairesCreate, name: 'anneescolaires.create' },
    { path: '/anneescolaires/:id', component: AnneescolairesShow, name: 'anneescolaires.show' },
    { path: '/anneescolaires/:id/edit', component: AnneescolairesEdit, name: 'anneescolaires.edit' },
    { path: '/cycles', component: CyclesIndex, name: 'cycles.index' },
    { path: '/cycles/create', component: CyclesCreate, name: 'cycles.create' },
    { path: '/cycles/:id', component: CyclesShow, name: 'cycles.show' },
    { path: '/cycles/:id/edit', component: CyclesEdit, name: 'cycles.edit' },
    { path: '/niveaux', component: NiveauxIndex, name: 'niveaux.index' },
    { path: '/niveaux/create', component: NiveauxCreate, name: 'niveaux.create' },
    { path: '/niveaux/:id', component: NiveauxShow, name: 'niveaux.show' },
    { path: '/niveaux/:id/edit', component: NiveauxEdit, name: 'niveaux.edit' },
    { path: '/branches', component: BranchesIndex, name: 'branches.index' },
    { path: '/branches/create', component: BranchesCreate, name: 'branches.create' },
    { path: '/branches/:id', component: BranchesShow, name: 'branches.show' },
    { path: '/branches/:id/edit', component: BranchesEdit, name: 'branches.edit' },
    ...
    { path: '/quartiers', component: QuartiersIndex, name: 'quartiers.index' },
    { path: '/quartiers/create', component: QuartiersCreate, name: 'quartiers.create' },
    { path: '/quartiers/:id', component: QuartiersShow, name: 'quartiers.show' },
    { path: '/quartiers/:id/edit', component: QuartiersEdit, name: 'quartiers.edit' },
    { path: '/vehicules', component: VehiculesIndex, name: 'vehicules.index' },
    { path: '/vehicules/create', component: VehiculesCreate, name: 'vehicules.create' },
    { path: '/vehicules/:id', component: VehiculesShow, name: 'vehicules.show' },
    { path: '/vehicules/:id/edit', component: VehiculesEdit, name: 'vehicules.edit' },
    { path: '/circuits', component: CircuitsIndex, name: 'circuits.index' },
    { path: '/circuits/create', component: CircuitsCreate, name: 'circuits.create' },
    ...
    { path: '/familles', component: FamillesIndex, name: 'familles.index' },
    { path: '/familles/create', component: FamillesCreate, name: 'familles.create' },
    { path: '/familles/:id', component: FamillesShow, name: 'familles.show' },
    { path: '/familles/:id/edit', component: FamillesEdit, name: 'familles.edit' },
    { path: '/tuteurs', component: TuteursIndex, name: 'tuteurs.index' },
    { path: '/tuteurs/create', component: TuteursCreate, name: 'tuteurs.create' },
    { path: '/tuteurs/:id', component: TuteursShow, name: 'tuteurs.show' },
    { path: '/tuteurs/:id/edit', component: TuteursEdit, name: 'tuteurs.edit' },
    { path: '/lienparentes', component: LienparentesIndex, name: 'lienparentes.index' },
    { path: '/lienparentes/create', component: LienparentesCreate, name: 'lienparentes.create' },
    { path: '/lienparentes/:id', component: LienparentesShow, name: 'lienparentes.show' },
    { path: '/lienparentes/:id/edit', component: LienparentesEdit, name: 'lienparentes.edit' },
    { path: '/communes', component: CommunesIndex, name: 'communes.index' },
    { path: '/communes/create', component: CommunesCreate, name: 'communes.create' },
    { path: '/communes/:id', component: CommunesShow, name: 'communes.show' },
    { path: '/communes/:id/edit', component: CommunesEdit, name: 'communes.edit' },
]
