...
return [
	...
		'anneescolaire' => [		'title' => 'Annee scolaire',		'fields' => [			'datedebut' => 'Date Debut',			'datefin' => 'Date Fin',			'label' => 'Label',			'anneeactive' => 'Annee Active',		],	],
		'cycle' => [		'title' => 'Cycle',		'fields' => [			'label-fr' => 'Label fr',			'label-ar' => 'Label ar',		],	],
		'niveau' => [		'title' => 'Niveau',		'fields' => [			'label-fr' => 'Label fr',			'label-ar' => 'Label ar',		],	],
		'branche' => [		'title' => 'Branche',		'fields' => [			'label-fr' => 'Label fr',			'label-ar' => 'Label ar',		],	],
		'classe' => [		'title' => 'Classe',		'fields' => [			'code' => 'Code',			'label-fr' => 'Label fr',			'idmassar' => 'Massar',			'capacite' => 'Capacite',			'niveau' => 'Niveau',			'branche' => 'Branche',		],	],
		'quartier' => [		'title' => 'Quartier',		'fields' => [			'label' => 'Label',		],	],
		'vehicule' => [		'title' => 'Vehicule',		'fields' => [			'code' => 'Code',			'marque' => 'Marque',			'matricule' => 'Matricule',			'datemiseencirculation' => 'Date Mise Encirculation',			'dateacquisition' => 'Date Acquisition',			'echeanceassurance' => 'Echeance Assurance',			'nombredeplace' => 'Nombre de Place',			'echeancevisitetechnique' => 'Echeance Visite Technique',			'echeanceautorisation' => 'Echeance Autorisation',			'consommationmin' => 'Consommation Minimal',			'consommationmax' => 'Consommation Maximal',			'vidange' => 'Vidange',			'observations' => 'Observations',		],	],
		'circuit' => [		'title' => 'Circuit',		'fields' => [			'label' => 'Label',			'vehicule' => 'Vehicule',		],	],
		'famille' => [		'title' => 'Famille',		'fields' => [			'nom' => 'Nom',		],	],
		'lienparente' => [		'title' => 'Lienparente',		'fields' => [			'label' => 'Label',		],	],
		'commune' => [		'title' => 'Commune',		'fields' => [			'label-fr' => 'Label fr',			'label-ar' => 'Label ar',		],	],
		'tuteur' => [		'title' => 'Tuteur',		'fields' => [			'prenom-fr' => 'Prenom fr',			'prenom-ar' => 'Prenom ar',			'nom-fr' => 'Nom fr',			'nom-ar' => 'Nom ar',			'adresse' => 'Adresse',			'cin' => 'Cin',			'email' => 'Email',			'tel' => 'Tel',			'ville' => 'Ville',			'profession' => 'Profession',			'lienparente' => 'Lien Parente',			'famille' => 'Famille',		],	],
		'eleve' => [		'title' => 'Eleve',		'fields' => [			'matricule' => 'Matricule',			'img-path' => 'Photo',			'prenom-fr' => 'Prenom fr',			'prenom-ar' => 'Prenom ar',			'nom-fr' => 'Nom fr',			'nom-ar' => 'Nom ar',			'sexe' => 'Sexe',			'cin' => 'Cin',			'cne' => 'Cne',			'idmassar' => 'Massar',			'tel' => 'Tel',			'adresse' => 'Adresse',			'datenaissance' => 'Date Naissance',			'datepremiereentree' => 'Date Premiere Entree',			'email' => 'Email',			'nationalite' => 'Nationalite',			'groupesangin' => 'Groupesangin',			'is-handicaped' => 'Handicap',			'pediatrenom' => 'Pediatre Nom',			'telpediatre' => 'Tele Pediatre',			'allergies' => 'Allergies',			'particularites' => 'Particularites',			'traitement' => 'Traitement',			'nbreanneedouble' => 'nbr Annee Double',			'allergiealimentaire' => 'Allergie Alimentaire',			'intolerancealimentaire' => 'Intolerance Alimentaire',			'comportementalimentaire' => 'Comportement Alimentaire',			'famille' => 'Famille',			'tuteur' => 'Tuteur',			'quartier' => 'Quartier',		],	],
		'preinscription' => [		'title' => 'Preinscription',		'fields' => [			'nomprofesseurtest' => 'Nom Professeur Test',			'notetest' => 'Note Test',			'resultattest' => 'Resultat Test',			'is-acceptedintest' => 'Test Accepte',			'fraistest' => 'Frais Test',			'fraispayed' => 'Frais Payed',			'transport' => 'Transport',			'datetest' => 'Date Test',			'datelimiteinscription' => 'Date Limite Inscription',			'observations' => 'Observations',			'anneescolaire' => 'Annees colaire',			'eleve' => 'Eleve',		],	],
